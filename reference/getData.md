...
- tree_hm:
  ...
  The output of
  [`TreeHeatmap`](https://csoneson.github.io/treeclimbR/reference/TreeHeatmap.md).

- type:

  A character scalar indicating the type of information to extract.
  Should be one of
  `"heatmap", "row_name", "column_name", "title", "column_anno", "column_order"`.

## Value

A `data.frame` (if `type` is not "column_order"), or a vector of column
names (if `type` is "column_order").
